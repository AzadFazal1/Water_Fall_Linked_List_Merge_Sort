...
void test_reverse_nth()
{
    ...
    std::cout<< list_r << std::endl;
    list_r.reverse_nth(3);
    std::cout<< list_r << std::endl;
...
void test_split()
{
    ...
    std::cout<< list_s1 <<std::endl;
    auto list_s2 = list_s1.split(8);
    std::cout<< list_s1 <<std::endl;
    std::cout<< list_s2 <<std::endl;
...
void test_merge()
{
    ...
    std::cout<< "List 1 =  " << list_m1;
    dl_list<int> list_m2;
    for(int i = 2; i <= 10; i+=2)
    {
        list_m2.push_back(i);
    }
    std::cout<< "List 2 =  " << list_m2 <<std::endl;

    list_m2.merge(list_m1);
    std::cout<< " Merged List =  " <<list_m2 <<std::endl;
...
void test_sort()
{
    ...
    std::cout<< "Un-sorted List =  " << list_s1 <<std::endl;
    list_s1.sort();
    std::cout<< " Sorted List =  " << list_s1 <<std::endl;
...
*/
    ...
    std::cout<< "img sort = " << img_srt <<std::endl;
